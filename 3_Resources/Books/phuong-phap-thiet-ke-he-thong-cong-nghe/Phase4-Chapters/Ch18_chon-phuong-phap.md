...
flowchart TD
    ...
    subgraph BUOC1["Bước 1 — Chấm tổ chức, không chấm dự án"]
        B1["Chấm 5 giả định của Ch13<br/>mỗi giả định 0 / 1 / 2 điểm<br/>bằng chứng quan sát được"] --> T{"Tổng điểm<br/>0 đến 10"}
    end

    T -->|"0 đến 3"| L1["Vùng THẤP"]
    T -->|"4 đến 7"| L2["Vùng GIỮA"]
    T -->|"8 đến 10"| L3["Vùng CAO"]

    subgraph BUOC2["Bước 2 — Loại phương pháp không nuôi nổi"]
        L1 --> E1["Loại: khung bảy bước bắt buộc,<br/>chữ V đầy đủ hai nhánh,<br/>ICDM bản đủ bảy công cụ"]
        L2 --> E2["Loại: chữ V đầy đủ nếu G5 dưới 2 điểm<br/>Giữ: cắt may theo VDI 2221 Blatt 2<br/>Giữ: PBSA rút gọn"]
...
Năm giả định đến từ Chương 13, và Chương 13 dựng chúng từ hội tụ của năm khối tài liệu độc lập: hợp tác
liên ngành thông suốt, đồng thuận văn hoá giữa kỹ sư và quản lý, kỷ luật quy trình cao, nguồn lực dồi
dào cho pha trừu tượng đầu dự án, thuật ngữ thống nhất giữa cơ — điện — phần mềm.
...
| # | Giả định | 0 điểm — quan sát được | 1 điểm | 2 điểm |
|---|---|---|---|---|
| **G1** | Hợp tác liên ngành thông suốt | Thông tin giữa các bộ phận đi bằng biên bản một chiều; không buổi nào có mặt đồng thời cả cơ, điện, phần mềm trong ba tháng qua | Có họp chung nhưng chỉ để báo cáo, không ra quyết định trong buổi | Quyết định thiết kế liên ngành được ra **trong** buổi họp chung, có bản ghi tên người chốt |
| **G2** | Đồng thuận văn hoá kỹ sư và quản lý | Quản lý đòi bản vẽ cụ thể ngay tuần đầu; hoặc kỹ sư từ chối viết bất cứ thứ gì không phải bản vẽ | Một phía chấp nhận, phía kia làm cho xong | Cả hai phía **cùng đòi** phía kia làm có hệ thống — đúng dấu hiệu nêu trong nguồn |
| **G3** | Kỷ luật quy trình | Không tìm được bản ghi của lần ra quyết định lớn gần nhất | Có bản ghi nhưng lập sau khi đã quyết | Bản ghi lập **trước** quyết định và được mở lại khi rà soát |
| **G4** | Nguồn lực cho pha trừu tượng | Dự án gần nhất đi thẳng vào CAD trong tuần đầu tiên | Có pha trừu tượng nhưng bị cắt khi lịch trượt | Pha trừu tượng có ngân sách riêng, không phải thứ bị cắt đầu tiên khi lịch trượt |
| **G5** | Thuật ngữ thống nhất cơ — điện — phần mềm | Ba miền dùng ba cách gọi khác nhau cho cùng một giao diện, và không ai coi đó là vấn đề | Có bảng thuật ngữ nhưng không ai cập nhật | Bảng thuật ngữ có chủ, có ngày cập nhật gần nhất dưới 90 ngày |

**Quy tắc chấm.** Chấm tổ chức, không chấm dự án tốt nhất của tổ chức. Chấm bằng bằng chứng của ba
tháng gần nhất, không bằng ý định của quý tới. Người chấm phải là người có thể bị điểm thấp làm cho khó
xử — nếu người chấm không mất gì khi cho điểm thấp thì bảng này thành một bài tập.

**Đọc kết quả.** Tổng từ 0 đến 10. Nhưng con số tổng ít quan trọng hơn **ô nào bằng 0**. Một tổ chức 7
điểm với G5 bằng 0 nguy hiểm hơn một tổ chức 5 điểm rải đều, vì giả định bằng 0 là ràng buộc, và mọi đầu
tư vào bốn giả định còn lại đều chảy qua nó mà mất.
...
|---|---|---|---|
| **PBSA** bốn pha đầy đủ | Ch03 | G4 · G1 | Pha ý tưởng bị cắt đầu tiên khi lịch trượt; đội quay về chọn giữa vài ý tưởng có sẵn. Nguồn ghi chế độ này dưới tên thiếu thời gian và kinh phí |
| **VDI 2221:1993** bảy bước | Ch04 | G3 · G5 | Bảy bước thành bảy tập hồ sơ lập sau khi đã quyết. Nguồn xác nhận khung `"is based on 7 stages"`; điều nguồn không hứa là hồ sơ ấy dẫn được quyết định |
| **VDI 2221:2019** cắt may | Ch05 | G2 | Cắt may mà không có đồng thuận thì thành cắt bỏ. Người có quyền cắt luôn cắt phần mình không hiểu giá trị |
| **VDI 2206** chữ V, hai nhánh hoặc ba luồng | Ch06 · Ch07 | G5 · G1 | Cát cứ giữa phần cứng và phần mềm biến chữ V thành thủ tục giấy tờ đối phó; nguồn gọi chế độ này là thiếu `"lack of common interface language"` |
| **ICDM** bảy công cụ | Ch08 | G2 · G3 | Chấm điểm khi chưa có gì để đo cần một tổ chức chịu được điểm thấp công khai. Không có G2 thì thang điểm bị thương lượng ngược |
...
flowchart LR
    subgraph CHAM["Bảng tự chấm gộp: Ch13 vào, Ch16 ra"]
        direction TB
        H["Điểm 5 giả định Ch13:<br/>G1 G2 G3 G4 G5"]
    end
    ...
    H -->|"Tổng 8 đến 10,<br/>không ô nào bằng 0"| GIUA
    H -->|"Tổng 4 đến 7"| CAO
    H -->|"Tổng 0 đến 3"| CAO
...
chức có G3 bằng 0 sẽ điền biểu mẫu sau khi đã quyết. Thêm biểu mẫu vào chỗ ấy là đổ công sức vào đúng
...
người dự đúng buổi, cần thuật ngữ chung để phản hồi có nghĩa. Đó chính là G1 và G5. Xây vòng phản hồi
trên nền không có G1 thì vòng ấy chạy rỗng — nó sinh ra cuộc họp, không sinh ra thông tin.
...
**Trường hợp A — tổng 3, không ô nào bằng 0.**
G1=1 · G2=0 · G3=1 · G4=0 · G5=1. Hai ô bằng 0, nên thủ tục dừng ở bước 2 và không đi tiếp. Ràng buộc
phải chọn giữa G2 và G4. Chọn G2, vì G4 phụ thuộc G2: pha trừu tượng chỉ có ngân sách riêng khi cả kỹ
sư lẫn quản lý cùng coi nó đáng, và đó đúng là định nghĩa của G2. Can thiệp trục: đổi *ai được quyền
tuyên bố pha ý tưởng đã xong* — một luật chơi, tầng cao. Không ban hành phương pháp nào trong chu kỳ này.

**Trường hợp B — tổng 6, ô thấp nhất là G5 bằng 1.**
G1=2 · G2=1 · G3=1 · G4=1 · G5=1. Không ô nào bằng 0, thủ tục đi hết ba bước. Bước 2 loại chữ V đầy đủ
hai nhánh vì G5 dưới 2. Bước 3, với tổng trong khoảng 4 đến 7, chỉ vào tầng cao. Nhưng G1 bằng 2 là một
tài sản: đã có buổi ra được quyết định liên ngành. Can thiệp trục: gắn quyền quyết định vào chính buổi
đó — cụ thể là quy định rằng phương án nào không được nêu trong buổi có mặt cả ba miền thì không được
đưa vào pha cụ thể hoá. Đó là một luật chơi dựng trên hạ tầng đã có, không phải một hạ tầng mới.

**Trường hợp C — tổng 8, và một ô bằng 0.**
G1=2 · G2=2 · G3=2 · G4=2 · G5=0. Vùng cao, nhưng có ô bằng 0 nên thủ tục vẫn dừng ở bước 2 — luật ô
bằng 0 không có ngoại lệ cho điểm tổng cao. Đây là trường hợp mà bảng tổng điểm
sẽ nói sai nếu đọc một mình: tổ chức này đủ mạnh để chạy bất kỳ phương pháp nào trong Phần II, và sẽ
vẫn vấp, vì ba miền gọi cùng một giao diện bằng ba cái tên. Can thiệp trục: bảng thuật ngữ có chủ —
một can thiệp tầng giữa, không phải tầng cao, và đó là ngoại lệ hợp lệ duy nhất của luật "điểm thấp thì
can thiệp tầng cao", vì ở đây điểm không thấp.

| | A | B | C |
|---|---|---|---|
| Tổng | 3 | 6 | 8 |
| Ô bằng 0 | G2, G4 | không có | G5 |
| Thủ tục dừng ở | Bước 2 | đi hết Bước 3 | Bước 2 |
| Phương pháp bị loại ở dạng đầy đủ | tất cả | chữ V hai nhánh | không loại gì |
| Can thiệp trục | quyền tuyên bố pha ý tưởng xong | quyền đưa phương án vào pha cụ thể hoá | bảng thuật ngữ có chủ |
...
>
> **Nó chịu được sai một điểm.** Chấm G3 là 1 thay vì 2 hầu như không đổi đầu ra, vì đầu ra được lái
...
> và nó đặt cược đúng vào G2. Một tổ chức có G2 bằng 0 sẽ chấm sai bảng đo G2. Vòng lặp ấy có thật, và
> chương này không gỡ được nó từ bên trong; nó chỉ gỡ được bằng một người chấm từ bên ngoài.

---

## Những gì cuốn sách này không trả lời được

Bốn khoảng trống, không sắp xếp cho dễ nghe.
...
**Năm giả định hội tụ từ năm nguồn độc lập, nhưng qua cùng một bộ máy đọc.** Năm truy vấn chạy trên năm
notebook khác nhau, không notebook nào thấy câu trả lời của notebook kia. Sự hội tụ là thật ở mức đó.
Nhưng cả năm câu trả lời do cùng một mô hình sinh ra, và một mô hình có thể hội tụ vì tài liệu hội tụ,
...
*Dữ liệu:* điểm G1 đến G5 chấm tại thời điểm khởi động dự án, chấm bởi người không biết kết quả sau;
...
khác nhau. Quyết định ra được ngay trong tuần: **dành chín mươi phút chấm G1 đến G5 cho chính xưởng,
bằng bằng chứng ba tháng gần nhất, và không kèm bất kỳ đề xuất phương pháp nào trong cùng buổi đó.**
...
- **Chỗ là suy luận của tác giả, không phải của nguồn:**
  ...
  - Thang 0/1/2 và các mốc quan sát trong bảng chấm G1 đến G5.
  ...
  - Mục "Đào sâu: thủ tục này chịu được sai đến đâu" — kể cả phần thừa nhận rằng thủ tục này cũng đặt
    một canh bạc tổ chức của riêng nó, vào G2.
