...
## Trước khi có số hiệu: một phả hệ ba mươi năm
...
Đọc chậm câu này. Nó không nói phương pháp trở nên đúng hơn. Nó nói **đối tượng phục vụ đã đổi**: từ
...
Chú ý cái đuôi câu, vì nó sẽ quay lại ám cả chương: bước đầu tiên được chính tài liệu tổng quan gọi là
...
| # | Bước | Đầu vào | Đầu ra |
|---|---|---|---|
| 1 | *Clarify and define the task* | Nhiệm vụ thô từ khách hàng hoặc bộ phận kế hoạch sản phẩm | Bản đặc tả / danh sách yêu cầu (*Specification*) |
| 2 | *Determine functions and their structure* | Bản đặc tả từ bước 1 | Cấu trúc chức năng (*Function structures*) |
| 3 | *Search for solution principles and their combinations* | Cấu trúc chức năng từ bước 2 | Giải pháp nguyên lý (*Principal solutions*) |
| 4 | *Divide into realizable modules* | Giải pháp nguyên lý từ bước 3 | Cấu trúc mô-đun (*Module structures*) |
| 5 | *Develop layout of key modules* | Cấu trúc mô-đun từ bước 4 | Bản vẽ bố cục sơ bộ (*Preliminary layouts*) |
| 6 | *Complete overall layout* | Bố cục sơ bộ từ bước 5 | Bố cục xác định (*Definitive layouts*) |
| 7 | *Prepare production and operating instructions* | Bố cục xác định từ bước 6 | Hồ sơ tài liệu sản phẩm (*Product documents*) |
...
thì đã không ai chịu trả giá suốt năm mươi năm.
...
ở những dự án nhỏ, xa nước Đức. Corpus có hai dự án chạy trọn bộ khung và công bố kết quả đo:

- Một thiết bị ngưng tụ nước từ không khí. Khung thép ASTM A36 tính ra `"a safety factor of 1.45"`, trục
  nhôm 6061 của turbine cho `"the safety factor of 2.57379"`, và kết quả chạy thử:
  `"This device functions successfully and can produce 6 ml of water within 1 hour of testing."` [3]
- Một máy in 3D FDM kiểu cantilever làm từ nhựa chai tái chế, `"achieves nozzle temperatures up to 270°C
  and bed temperatures up to 80°C"`, `"with a total production cost of Rp 3,657,000.00."` [6]
...
Bốn món hàng thật. Bây giờ đến hoá đơn.
...
Đọc kỹ vế sau dấu gạch — *even though they usually try to emphasise*. Tài liệu **có** nhắc phải liên tục
