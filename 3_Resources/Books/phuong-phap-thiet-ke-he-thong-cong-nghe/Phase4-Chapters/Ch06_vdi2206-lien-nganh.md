...
term “mechatronics”"` [23]. Ba mươi lăm năm sau mới có một tiêu chuẩn thiết kế mang tên nó. Khoảng cách
ba mươi lăm năm ấy là khoảng thời gian ngành thiết kế cần để thừa nhận rằng một sản phẩm gồm ba miền
...
## Hạt nhân dùng chung: hai tiêu chuẩn cách nhau ba mươi năm

Đặt micro-cycle của VDI 2206 cạnh chuỗi giải quyết vấn đề tổng quát của Pahl-Beitz ở Chương 03 thì thấy
một điều đáng khai thác: **hai văn bản, hai trường phái, cách nhau ba mươi năm, cùng đặt một hạt nhân
giống nhau vào đúng cùng một vị trí trong kiến trúc phương pháp của mình.**
...
| Số bước có nguyên văn không | **KHÔNG.** Sách vẽ Figure 4.1 và mô tả nội dung nhưng **không có câu văn nào đếm số bước** | **KHÔNG.** Tệp khám phá ghi thẳng *"không có trong nguồn"* |
| Cái được kiểm chứng | tên và thứ tự các bước | sự tồn tại và vị trí của chu trình |
| Cái không được kiểm chứng | phép đếm | phép đếm **và** danh sách bước |
...
tượng này ở danh sách mười lăm bước cụ thể hoá, nơi bản gốc còn nói thẳng
`"it is not always possible to draw up a strict plan for the embodiment design phase"` ngay trước danh
sách. Ba lần cùng một lớp bẫy, trong ba chỗ khác nhau của cùng một phả hệ.
...
Gạt hết chi tiết kỹ thuật đi thì bản 2004 đặt cược vào bốn điều. Ba điều đầu có bằng chứng trực tiếp trong
nguồn; điều thứ tư là điều kiện để ba điều kia có nghĩa.

**Một — kỹ sư của ba miền nói chung một ngôn ngữ mô hình hoá.** Đây là canh bạc trung tâm, và nguồn phát
biểu nó gần như thành lời: tổ chức áp dụng được giả định có `"các kỹ sư đa ngành có khả năng thấu hiểu và
sử dụng chung một ngôn ngữ mô hình hoá bán chính quy"`, và kịch bản đổ vỡ được ghi ngay bên cạnh là
`lack of common interface language` [25]. Toàn bộ giá trị của chữ V nằm ở hai mũi tên ngang nối trái với
...
| Hệ thống cộng gộp được qua giao diện khai báo | mô tả phân rã thành `verifiable units` [23] | tương tác đi vòng qua giao diện: nhiệt, rung, nhiễu, trễ |
...
**Coi chừng:** viết câu xác minh thì dễ, câu thẩm định thì hay bị biến thành câu xác minh thứ hai. Nếu cả
...
**Coi chừng:** nếu tên ghi cho mọi mặt cắt đều là cùng một người — thường là người giỏi nhất xưởng — thì
...
**Coi chừng:** bảng này chết ngay khi có hai bản. Nếu bảng được xuất ra rồi mỗi miền giữ một bản chép,
...
**Coi chừng:** đóng băng cơ khí trước khi phần mềm chạy thử lần nào là cách chắc chắn nhất để biến phần
...
**Coi chừng:** tập ghi chép này chỉ sống nếu ghi mà không bị phạt. Nếu người ghi hiểu rằng ghi là tự khai
