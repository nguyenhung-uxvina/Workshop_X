...
*"quy trình trừu tượng hoá năm bước"*. Cùng lớp bẫy đó áp cho chuỗi cụ thể hoá — văn bản đánh số
từ 1 đến 15 ở mục 7.1 nhưng không câu nào đếm — và cho các quy tắc cơ bản của pha cụ thể hoá. Đọc
...
Đây là chỗ bất ngờ. Tuyến phê bình đánh gần như mọi thứ khác của phương pháp hệ thống: tính tuyến
...
Sự đồng thuận này hiếm đến mức đáng ghi thành một quy tắc làm việc: **khi hai phe đối lập cùng
...
>
> **Giá thứ nhất — trừu tượng quá tay chặn đường tìm giải pháp.**
...
>
> Và trong công nghiệp, thẳng hơn:
> `"In many cases in industry it may not be expedient to build up a function structure from
> generally valid subfunctions, because they are, in fact, too general and thus do not provide a
> sufficiently concrete picture of the relationships to aid the sub-sequent search for
> solutions."` [1]
>
> **Giá thứ hai — trung lập với giải pháp là một lý tưởng không đạt được.**
> `"Moreover, it should be remembered that function structures are seldom com-pletely free of
> physical or formal presuppositions, which means that the number of possible solutions is
> inevitably restricted to some extent."` [1]
>
> Định kiến không bị xoá; nó bị đẩy xuống chỗ khó nhìn thấy hơn. Ai tin rằng cấu trúc chức năng
> của mình hoàn toàn sạch định kiến thì đã mắc đúng cái bẫy mà công cụ này định gỡ.
>
> **Giá thứ ba — người thật thấy nó khó chịu.**
> `"Abstracting and creating function structures often causes difficulties because of the abstract
> representation. Designers are more used to thinking in objects and visual images [12.6]."` [1]
>
...
>
> **Giá thứ tư — thời gian.**
> `"The process-oriented approach largely avoids the potential disadvantages of the
> problem-oriented approach. However, more time is required because of the wider, more systematic
> perspective. This carries the danger of generating an unnecessarily large solution space."` [1]
>
> `"The objection is often raised that applying a systematic approach during the conceptual design
> phase takes too much time."` [1]
>
> Bốn câu trên đều nằm trong chính cuốn sách bị phê bình. Đó là dữ kiện đáng giữ lấy: **phần lớn
...
Đối tượng là sinh viên kỹ thuật cơ khí, không phải kỹ sư công nghiệp. Đó là giới hạn của thí
nghiệm, và nó phải được nói ra cùng lúc với kết luận:
...
Bây giờ là chỗ dễ trượt nhất trong cả chương. Kết luận trên nói PBSA **chưa hoàn thiện với tư cách
...
Ba mảnh bằng chứng cho thấy canh bạc ấy được thanh toán thế nào ngoài đời.
...
- **Con số đã BỎ vì không có nguyên văn:**
  ...
  - *mười lăm bước cụ thể hoá* — nguồn đánh số 1–15 ở mục 7.1 nhưng không câu nào đếm; chỉ nhắc
    như ví dụ về lớp bẫy, không dùng làm con số
