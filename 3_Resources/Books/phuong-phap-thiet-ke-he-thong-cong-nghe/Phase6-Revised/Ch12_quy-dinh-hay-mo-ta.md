...
- **Con số đã BỎ vì không có nguyên văn:** ngưỡng hệ số xác định cho tiêu chí *tính tuyến tính* — vật
  ...
  lâm sàng — nguồn liệt kê nhưng không tự đếm, chương chép nguyên văn từng câu và nói rõ điều đó, kể
  cả ở tiêu đề mục *Áp dụng ở Xưởng* số 2 (bản nháp đầu ghi "sáu câu hỏi" ở hai chỗ, mâu thuẫn với
  chính khai báo này — đã bỏ con số) · số thước đo đọc đồ thị tích luỹ — nguồn liệt kê từng thước
  nhưng không tự đếm, bản nháp đầu ghi "bốn thước đo" ở tiêu đề khung *Đào sâu*, đã bỏ con số · ba
...
- **Chỗ là suy luận của tác giả, không phải của nguồn:** thuật ngữ **mặt tiếp giáp** (của cuốn sách,
  ...
  **Motte** mà không trích câu nào — đã khai báo ngay trong thân bài · **điều kiện đối xứng** (cần
  thấy gì mới nói một phương pháp đáng giữ) — hoàn toàn do tác giả đặt, và chương nói ra điều đó tại chỗ.
- **Phân nhà với Chương 02:** toàn bộ số đo của phép thử Kannengiesser & Gero — 87 / 235 / 46 phiên /
  45 phút / ngưỡng 25 bước, kết luận *incomplete*, câu *waterfall*, phép loại suy đèn đỏ, và hai câu
  buộc tội của Jensen & Andreasen — **thuộc về Chương 02**. Chương này tóm bằng ba câu rồi trỏ về, và
  định vị mình bằng hai thứ Chương 02 không thể có: **ba điều kiện bác bỏ** (kèm vế đối xứng) và
  **bảng chứng minh / không chứng minh**. Bản nháp đầu dựng lại toàn bộ phép thử và mở chương bằng chữ
  *"lộ ra lần đầu"* — cả hai đã sửa.
- **Số dòng:** 666
