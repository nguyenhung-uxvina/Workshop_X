...
- **Neo luận đề:** *Mặt tiếp giáp* — đoạn mở thứ nhất (tập giả định không viết ra = canh bạc tổ chức), mục
  *Bằng chứng này được tạo ra thế nào* (hội tụ bốn khối độc lập), và mục **Giả định 4** (khoảng cách giữa
  lúc phương pháp giả định một điều kiện và lúc điều kiện ấy tồn tại). Neo phụ *Canh bạc* ở đoạn mở và bảng
  tự chấm.
- **Nối chương:** ngược về Ch12 đích danh ở đoạn mở thứ hai (từ *"mô tả sai người thiết kế"* sang *"giả định
  sai tổ chức"*, giữ nguyên phân biệt *mô tả sai ≠ vô dụng*); nhắc Ch05 ở Giả định 5, Ch06/Ch07 ở Giả định 4,
  Ch01 ở mục ranh giới notebook thứ năm. Xuôi tới Ch14 ở cuối Giả định 5 và Ch16 ở cuối *Đào sâu* thứ nhất.
- **Số giả định truy được nguyên văn: 5/5.** Đẩy xuống phụ lục: **3** (PL-1 hạ tầng số hoá · PL-2 bản mạnh
  về văn hoá kỹ sư ↔ quản lý · PL-3 mặt bằng trình độ nhân sự). Ch17 và Ch18 chỉ được trích năm mục vào thân
  chương, đúng thứ tự và đúng tên gọi ở đây; ba mệnh đề phụ lục không được kéo lên và không được gán tầng.
- **Nguồn đã dùng:** [1], [2], [10], [13], [14], [19], [20], [25], [26], [27], [43], [44], [46].
- **Con số có nguyên văn:** `roughly 30%` dự án ngoài hoạch định [43] · `around 60 to 70%` thời gian cụ thể
  hoá [1] — trích kèm vế `"is about the same as when a systematic approach is not used"` theo LUẬT 2, vì bỏ
  vế đó là đảo ngược ý nguồn · `sixteen professional designers` [44] · `50 per year` sinh viên [43] ·
  `2007-2009` nghiên cứu thực địa [43] · `ten groups of contextual factors` nhắc lại từ Ch05.
- **Con số của cuốn sách, không của nguồn:** tỷ lệ ma trận 2/4, 3/4, 4/4 — phép đếm trên bốn khối tài liệu,
  đã ghi rõ trong bảng, trong cột *Khối · nguồn*, và trong *Đào sâu* thứ hai; **năm trên mười lăm cạnh** của
  ma trận có số hiệu nguồn hiện trong chương.
- **Con số đã BỎ vì không có nguyên văn hoặc vì mâu thuẫn trong corpus:** độ dài Weißdruck của VDI 2221
  (corpus có **hai** con số cho cùng một văn bản: `42 pages` và `a 52-page text`) · năm công bố thực nghiệm
  mười sáu nhà thiết kế (câu nguyên văn không chứa năm — đã bỏ năm, giữ cỡ mẫu) · số doanh nghiệp trong
  nghiên cứu thực địa Đan Mạch.
- **Chỗ là suy luận của tác giả, không phải của nguồn:**
  1. Việc gom thành đúng năm mục và đặt tên cho chúng — không nguồn nào đưa ra danh sách này.
  2. Toàn bộ **bảng tự chấm**: thang 0–1–2, bốn vạch chia 0–3 / 4–6 / 7–8 / 9–10, cửa sổ bằng chứng sáu
     tháng, và ánh xạ mỗi giả định sang một hành động. Đã khai báo ngay dưới bảng. Ch18 dùng lại đúng thang
     này, đúng vạch chia này và đúng cửa sổ này.
  3. Luận điểm *"hai chế độ hỏng ngược chiều cùng vi phạm một giả định"* — hai chế độ đều có nguyên văn [43],
     việc nối chúng thành một vòng lặp là của cuốn sách.
  4. Phép thử bác bỏ ở *Đào sâu* thứ hai (bốn dấu hiệu của một hội tụ giả).
  5. Nhận xét rằng năm giả định vào thân chương thuộc loại *quan hệ* còn ba mệnh đề phụ lục thuộc loại
     *năng lực* — đã ghi rõ là chưa phân biệt được nguyên nhân.
  6. Ranh giới loại notebook thứ năm ra khỏi vai bằng chứng — LUẬT 4 của dự án, không phải phát biểu của nguồn.
  7. Hai lý do cho hai ô trống GĐ2×nền-móng và GĐ5×VDI-2206 — suy luận về sự im lặng, yếu hơn ba lý do kia.
- **Cổng an ninh LUẬT 5:** mục *Áp dụng ở Xưởng* không chứa tên riêng, mã sản phẩm, tên dự án, tên đơn vị,
  tên người, số liệu vận hành, tên nhà cung cấp, hay bất kỳ chỉ dấu lĩnh vực nào.