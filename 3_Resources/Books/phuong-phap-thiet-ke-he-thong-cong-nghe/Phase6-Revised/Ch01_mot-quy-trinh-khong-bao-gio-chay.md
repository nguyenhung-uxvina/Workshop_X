...
- **Neo luận đề:** Canh bạc — nối ở mục *Bốn khối tài liệu, hỏi cùng một câu* (định nghĩa thuật ngữ
  *canh bạc tổ chức* từ hội tụ bốn khối tài liệu) và ở mục *Ba neo, và chương nào nối về đâu* (bảng ánh
...
- **Con số đã BỎ vì không có nguyên văn:**
  ...
  - **số bước của pha cụ thể hoá Pahl-Beitz** — đã cố ý không nêu con số ở chương này. Nguồn liệt kê đủ
    ...
    **1.167.487 ký tự** — toàn bộ văn bản trích ra được của [1], đúng phép đo mà danh mục nguồn dùng và
    cũng là con số ở *Khai báo 3*. Con số thuộc về Ch03, kèm câu phủ nhận liền trước danh sách.
...
- **Chỗ là suy luận của tác giả, không phải của nguồn:**
  ...
  - Cảnh báo rằng hội tụ bốn truy vấn có thể là trùng khớp do cùng một mô hình sinh ra — quan sát về
    phương pháp làm việc của dự án, không phải nội dung nguồn.
  - Việc **loại tuyến tư duy hệ thống khỏi phép đếm bằng chứng** (năm khối → bốn khối, khối thứ năm giữ
    vai lăng kính) — quyết định biên tập của cuốn sách, áp cùng luật đã dùng cho các phương pháp khác.
- **Số dòng:** 501
