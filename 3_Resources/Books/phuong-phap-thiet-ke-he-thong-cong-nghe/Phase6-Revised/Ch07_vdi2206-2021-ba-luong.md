...
- **Mục *Cái giá của việc bỏ hình chữ V*** là **suy luận của cuốn sách**: chữ V mã hoá tính đối xứng xác
  minh, ba luồng thì không. Không nguồn nào nêu đánh đổi này; đã nói ra tại chỗ.
...
- **Phân nhà với Chương 06:** bản nháp đầu trùng **mười sáu trích** với Ch06. Khối nguồn gốc về nhà Ch06
  — *mechatronics* 1969, bản 2004 và định nghĩa bốn pha, bốn ý tưởng nền Haberfellner, câu tiếng Pháp của
  [20] — đã bỏ và thay bằng câu trỏ. Giữ lại đúng hai mốc: 1993/1995 (luận điểm *chữ V vay từ ngành mà
  vật lý không tính tiền* tựa lên nó) và 2004 (phép trừ mười bảy năm cần cả hai đầu). Khối RFLP/SysML/
  giao diện ([20], [27]) ở lại đây vì đó là nội dung bản 2021.
- **Phép đếm đã sửa:** bản nháp đầu viết *"hai mươi năm"* ×2 và *"mười sáu năm"* ×3 cho cùng khoảng cách
  2004 → 2021. Số đúng là **mười bảy**, và cả hai đầu mốc có nguyên văn ngay trong bảng của chính chương.
  Đã thống nhất ở mọi chỗ, kể cả nhãn sơ đồ đối chiếu.
...
- **Con số có nguyên văn:**
  ...
  - *bốn pha bản 2004* và *bốn ý tưởng nền Haberfellner* — nguyên văn ở **Chương 06**; chương này dùng
    luận điểm và trỏ về, không trích lại (xem mục *Phân nhà với Chương 06* dưới đây)
