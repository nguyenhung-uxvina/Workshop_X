...
- **Con số đã BỎ vì không có nguyên văn:**
  - Phép đếm **số công cụ ICDM**. Bản nháp đầu viết "bảy công cụ" ở năm chỗ. Không nguồn nào trong 66
    tài liệu đếm chúng: tệp khám phá `c6` kể sáu tên, bảng của chương có bảy dòng, danh mục thuật ngữ ở
    `Phase2-Positioning.md` có tám tên. Đã bỏ con số ở mọi chỗ và **nói ra trong thân bài** rằng nguồn
    không đếm, kèm khai báo rằng phép chia *công cụ thiết kế* / *thước đo đặt lên người thiết kế* là
    thao tác của cuốn sách.
  - **"Hai mươi năm nghiên cứu"** cho ICDM. Bản nháp đầu dùng cụm này cách 180 dòng sau khi chính chương
    trích `"developed in the Technion, Israel during 1996 and 2001"` [49]. Không nguyên văn nào đặt "20
    năm" cạnh ICDM — chuỗi `"at least 20 years"` trong corpus nói về QFD, `"15 – 20 years of experience
    each"` nói về kinh nghiệm của sáu kỹ sư trong một ca nghiên cứu. Đã thay bằng **hai mốc có nguyên
    văn**, không làm phép trừ.
...
- **Ràng buộc R5 (không trùng cuốn `icdm-hari-weiss`):** các công cụ chỉ được **nêu tên** trong một
  bảng, mỗi dòng một câu nói nó cắt vào bước nào. Không công thức, không thang điểm, không biểu mẫu,
