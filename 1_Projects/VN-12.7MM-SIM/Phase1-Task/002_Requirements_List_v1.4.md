...
**Document**: VN-12.7MM-SIM-002-REQ | **Version**: 1.4 | **Date**: 2026-03-20
...
| S-022 | W1 | Sub-skill isolation drills | Instructor can select and repeat individual skill drills (e.g., lead tracking only, burst control only, target acquisition only) without running full scenario. ≥ 5 drill types. | Test |
| S-023 | D | Automated training report | System generates MoD-format training report (PDF/DOCX) per session. Includes: gunner ID, scenario, scores, pass/fail per standard, instructor notes. No manual data entry required. | Test |
| S-024 | W1 | Cross-session performance trends | Display performance trends per gunner over ≥ 20 sessions. Metrics: hit rate, reaction time, tracking error, burst discipline. Exportable as chart + table. | Test |
...
| PR-008 | D | Field setup time | Cold start to training-ready ≤ 8 min by 2 persons (I-01/CTR). Includes power-on, BIST, scenario load. Excludes compressor pressurization (concurrent). | Time study |
...
| 1.4 | 2026-03-20 | KN (forge-job-map CEO decision) | +4 requirements from ODI Opportunity Landscape gaps: PR-008 (field setup time ≤ 8 min), S-022 (sub-skill drills [W1]), S-023 (auto MoD-format report [D]), S-024 (cross-session trends [W1]). Source: forge-job-map outcomes O-13, O-48, O-51, O-52. Total: 201→**205**. |
