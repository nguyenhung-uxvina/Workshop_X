...
> **Mục đích:** Quy trình phối hợp với Navy Procurement từ khi trình dự án đến khi nghiệm thu. Đảm bảo Workshop X chuẩn bị đúng tài liệu, đúng thời điểm, đúng format để được duyệt ngân sách và ký nghiệm thu.
>
...
>
> **Quy ước:**
> - **PROC** = Navy Procurement Officer
> - **TECH** = Navy Technical Review Board (hội đồng kỹ thuật)
> - **WX** = Workshop X (CEO + team)
> - **USER** = Navy UUV Ops Team (S1 — người sử dụng cuối)
...
| 1.7 | **Hồ sơ năng lực Workshop X** | WX | Kinh nghiệm, thiết bị, nhân lực, dự án tương tự | [ ] |
...
|---|------|-------|----------|---------|
| 2.1 | Gửi hồ sơ đề xuất cho PROC | WX | ___ bộ, format ___ | [ ] |
| 2.2 | PROC kiểm tra tính đầy đủ hồ sơ | PROC | Checklist của PROC | [ ] |
| 2.3 | PROC chuyển cho TECH review | PROC | | [ ] |
...
| Gate 2 (Phase 2 done) | ___ | Concept Selection Report, Morphological Matrix, VDI 2225 Scoring | TECH |
...
**Địa điểm:** Xưởng đóng tàu / Workshop X
...
| F-02 | Trọng lượng (lightship) | <= 3,100 kg (~2,820 kg + 10% tolerance) | Cân | [ ] | Doc 008 estimate: ~2,820 kg |
...
- **Cho phép FAIL:** S-08 (SS 3 recovery — WISH), S-14 (tự vận hành — cần thêm đào tạo)
...
|---|-----------------|-----------|-----------|-----------|
| 11.1 | Vận hành LARS (launch/recovery) | ___ ngày | Ekip vận hành (3 người x ___ ekip) | Thực hành trên biển |
...
| 12.7 | Lessons learned đã ghi nhận | [ ] | WX lưu vào IPARAG |
...
- [ ] Hồ sơ năng lực Workshop X (Step 1.7)
- [ ] Biết format tài liệu mà PROC yêu cầu (hỏi trước)
...
- [ ] Template báo cáo tiến độ đã thống nhất format với PROC
...
|---------|------|--------|---------|
| 1.0 | 2026-03-06 | Workshop X | Template ban đầu |
| 1.1 | 2026-03-07 | Workshop X | Cập nhật Phase 2: Twin outboard 2x40-60 HP (A2), electric LARS winch VFD 10 kN + genset 5-8 kW (A3), SAT speed 25 kts (S-01), LARS ops 2-5 kts (S-02), loaded displacement 3,843 kg (S-04), UUV 550 kg (S-10), ekip 3 người (S-14), lightship 2,820 kg > crane 2.5t (S-12), FAT lightship <= 3,100 kg (F-02), nội địa hóa "điện LARS" |
| | | | |

---

*SOP Procurement & Acceptance v1.0 | VN-XUONG-UUV Phase 1 | COD: Offload (AI draft, CEO + PROC review)*
