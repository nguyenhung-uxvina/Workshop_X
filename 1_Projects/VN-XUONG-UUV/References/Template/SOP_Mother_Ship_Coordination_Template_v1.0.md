...
> **Mục đích:** Kịch bản phối hợp giữa tàu mẹ và xuồng LARS, bao gồm: hạ/kéo xuồng, chuyển UUV bằng crane, kéo sát mạn, và thu hồi xuồng. Gửi cho Ship CO để review và thống nhất quy trình.
>
...
TÀU MẸ (tại cảng hoặc trên biển)
  ...
  |— [B] Chuyển UUV + tether cable từ tàu mẹ sang xuồng LARS (crane tàu mẹ)
  |— [B2] Kết nối tether cable với UUV + controller trên xuồng
  |— [C] Xuồng LARS tách khỏi tàu mẹ → transit đến khu vực
  |— [D] Xuồng LARS thực hiện launch/recovery UUV (xem SOP riêng)
...
> **LƯU Ý:** Xuồng LARS lightship ~2,820 kg > Crane SWL 2.5t → **KHÔNG THỂ CẨU XUỒNG**. Xuồng phải tự transit đến tàu mẹ hoặc được kéo sát mạn. Crane tàu mẹ chỉ dùng cho UUV (550 kg).
...
| A1-07 | Xuồng LARS đã kiểm tra trước (0A checklist PASS) | CMDR | [ ] | Xem SOP Launch/Recovery |
...
| A2-02 | SHIP CO giữ tàu mẹ hướng tạo vùng khuất sóng/gió | SHIP CO | Lee side | [ ] |
...
| B2-12 | **OP2 kết nối tether cable với UUV (connector C8)** | OP2 | Connector khớp, khóa | [ ] |
| B2-13 | **OP2 kết nối cable với controller, thử liên lạc** | OP2 | Controller: UUV CONNECTED | [ ] |
...
> Xem **SOP_UUV_Launch_Recovery_Template_v1.0.md** — quy trình launch/recovery do ekip xuồng LARS thực hiện.
>
...
| E-03 | Xuồng LARS tiếp cận tàu mẹ | CMDR | Tốc độ chậm, phía ___ (lee side) | |
...
| F-02 | **OP2 ngắt tether cable khỏi UUV** | OP2 | Connector C8 tháo | [ ] |
...
| G1-04 | ~~CRANE OP nâng xuồng LARS~~ | ~~CRANE OP~~ | **KHÔNG KHẢ THI: lightship 2,820 kg > SWL 2,500 kg** | |
...
**Trọng lượng cẩu: Xuồng LARS lightship = ~2,820 kg > Crane SWL 2,500 kg**
...
| MS-09 | Vị trí hạ xuồng LARS (mạn nào?) | Mạn ___ (phải/trái) | Lee side preferred |
...
| 5 | Nếu UUV rơi: đánh giá hư hại, báo OEM | SHIP CO |
...
- [ ] Emergency Procedures đã phổ biến cho TẤT CẢ người liên quan
- [ ] SHIP CO đã review và đồng ý SOP này

### Important (SHOULD có trước sea trials)

- [ ] Thử nghiệm crane với dummy load (trọng lượng tương đương UUV) trên tàu mẹ
...
- [ ] Video ghi lại lần thao tác đầu tiên (để review + huấn luyện)
- [ ] Bản vẽ 3D minh họa trình tự crane (để brief DECK CREW)
...
| 1.1 | 2026-03-06 | Workshop X | Thêm kết nối tether cable (B2-12/13), ngắt cable (F-02), bỏ USBL |
| 1.2 | 2026-03-07 | Workshop X | Phase 2 update: Xuồng 2,820 kg > crane 2.5t → không cẩu xuồng, chỉ cẩu UUV 550 kg. Phase A đổi thành cập mạn (không hạ bằng crane). G1 đánh dấu không khả thi. Crew 3 người confirmed. |

---

*SOP Mother Ship Coordination v1.0 | VN-XUONG-UUV Phase 1 | COD: Offload (AI draft, CEO + Ship CO review)*
