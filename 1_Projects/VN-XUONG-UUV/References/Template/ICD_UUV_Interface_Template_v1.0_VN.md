...
# Tài Liệu Kiểm Soát Giao Diện UUV (ICD) — Mẫu

**Dự án:** VN-XUONG-UUV — Xuồng Triển Khai & Thu Hồi UUV
**Mục đích:** Thu thập thông tin kỹ thuật từ nhà sản xuất UUV để thiết kế giá đỡ (cradle), hệ thống thả-thu (LARS), và quy trình vận hành.
**Hướng dẫn:** Điền vào các ô `___`. Mục chưa biết ghi "TBD". Đơn vị = SI (mm, kg, N).

---

## PHẦN A: THÔNG TIN CHUNG UUV

| # | Thông số | Giá trị | Đơn vị | Ghi chú |
|---|----------|---------|--------|---------|
| A1 | Mã hiệu/Tên UUV | ___ | — | |
| A2 | Nhà sản xuất | ___ | — | |
| A3 | Số serial | ___ | — | Hoặc "chung" |
| A4 | **Chiều dài toàn bộ (LOA)** | ___ | mm | Bao gồm ăng-ten, phần nhô |
| A5 | **Đường kính thân (lớn nhất)** | ___ | mm | Thân chính, không tính vây |
| A6 | **Chiều rộng tối đa (kể cả vây)** | ___ | mm | |
| A7 | **Chiều cao tối đa (kể cả ăng-ten)** | ___ | mm | Từ đáy đến đỉnh ăng-ten |
| A8 | Chiều cao tâm thân từ đáy | ___ | mm | |
...
| A14 | Điều kiện nổi (mặt nước) | Dương / Trung tính / Âm | — | |
| A15 | Góc chúi khi nổi | ___ | độ | |

---

## PHẦN B: KẾT CẤU & VẬN CHUYỂN
...
| B5 | **Vùng đỡ giá — ĐƯỢC PHÉP** | *(đính kèm bản vẽ)* | — | Vùng được đặt giá đỡ |
| B6 | **Vùng đỡ giá — CẤM** | *(đính kèm bản vẽ)* | — | Vùng cấm chạm (cảm biến, nắp) |
| B7 | Góc tiếp xúc giá đỡ khuyến nghị | ___ | độ | VD: yên chữ V 120 độ |
| B8 | Lực ngang tối đa lên vỏ | ___ | N | |
| B9 | **Gia tốc thẳng đứng tối đa** | ___ | g | |
| B10 | **Xung kích tối đa (va đập)** | ___ | g, ___ ms | |
| B11 | Vị trí điểm cẩu | *(đính kèm bản vẽ)* | — | |
| B12 | Loại dây cẩu | ___ | — | |
| B13 | Tải trọng an toàn dây cẩu | ___ | kg | |
| B14 | **Góc nghiêng dọc tối đa** | ___ | độ | Ảnh hưởng góc ram (mục tiêu 15 độ) |
| B15 | **Góc nghiêng ngang tối đa** | ___ | độ | |
...
> Cuộn cáp (drum) nằm BÊN TRONG UUV [đã xác nhận]. Workshop X cần thông số cáp để thiết kế đường dẫn cáp trên xuồng.
...
| G7 | Quy trình thả/thu OEM | [ ] Có  [ ] Không | |
...
*Mẫu ICD v1.3 | VN-XUONG-UUV Giai Đoạn 2 | Workshop X*
